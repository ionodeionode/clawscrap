...
**Browser automation extension** — A Chrome extension that connects to [ClawBridge](https://github.com/ionodeionode/clawbridge) server to automate browser tasks like AI image generation and social media posting.
...
- **[ClawBridge](https://github.com/ionodeionode/clawbridge)** server running
